...
#         global notification1_
#         global notification2_
#         global notification3_
#         global notification4_
#         global notification5_
...
#         notification1_ = resp12
#         print(resp12)
#         # # socketio.emit('Emitting response', broadcast=True)
#         # @socketio.on('subscribe_event')
#         # def handle_my_custom_event(response):
#         #     print(f'Respense set to: {response}')
           
#         # handle_my_custom_event(resp12)
#         print(resp12["status"])
...
#                 socketio.emit('exception1', {'exception': str(e)}, broadcast=True)
#                 notification5_ = {'exception': str(e)}
